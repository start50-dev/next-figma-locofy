...
import styles from "./listing-description.module.css";

export type ListingDescriptionType = {
  className?: string;
};

const ListingDescription: NextPage<ListingDescriptionType> = ({
  className = "",
}) => {
  return (
